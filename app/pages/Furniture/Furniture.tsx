...
export default function FurniturePage() {
  ...
  return (
    <div className={`page-container bg-black ${playfair.className} ${loading ? '' : ''}`}>
            ...
            <div ref={contentRef} className="relative h-full opacity-0">
                <div className="container mx-auto px-64 h-full">
                    <main className="flex items-center w-screen h-full">
                        ...
                        <p className="w-[50vw] font-semibold text-[#fff3f3] text-lg m-auto items-center px-12 top-10 relative text-center hero-text-desc">Transform your home into a dream space with our stunning furniture collection. Each piece is crafted with meticulous attention to detail and the highest quality, ensuring not just striking aesthetics but also comfort and functionality.</p>
                        </div>
                    </main>
                </div>
            </div>
