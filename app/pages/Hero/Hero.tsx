    ...
    <div className={` ${playfair.className} h-screen w-screen bg-white`}>
      <div className="bg-white">
        <div className="flex flex-col image-trigger justify-center items-center relative top-20 text-[#beb8b2]">
          <h1 className="items-center md:text-[2vh] text-xl ">Furniture Solutions</h1>
          <h1 className="md:text-5xl text-2xl md:w-[50%] tracking-widest text-center font-normal">WHERE EXPERIENCE MEETS PERSONALIZATION</h1>
          <Image ref={imageRef2} src="/pxfuel.jpg" alt="kantor" width={1000} height={1000} priority className="md:w-[40%] w-[60%] z-10 rounded-lg md:top-28 top-10 relative"/>
